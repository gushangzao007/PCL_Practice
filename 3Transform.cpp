...
// You can either apply transform_1 or transform_2; they are the same
    pcl::transformPointCloud(*source_cloud, *transformed_cloud1, transform_1);
    ...
    pcl::visualization::PointCloudColorHandlerCustom<pcl::PointXYZ> transformed_cloud_color_handler1(transformed_cloud,
                                                                                                    0, 0, 250); // blue
    viewer.addPointCloud(transformed_cloud1, transformed_cloud_color_handler1, "transformed_cloud1");
