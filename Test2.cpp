...
int main(int argc, char **argv) {
    ...
    // pcl::VoxelGrid<pcl::PointNormal> sor;  // Create the filtering object
    ...
    gp3.setMinimumAngle(M_PI/36); // 10 degrees  /18
    gp3.setMaximumAngle(2*M_PI/2.5); // 120 degrees  /3
    ...
    // viewer.addPointCloud<pcl::PointNormal>(cloud_filtered,"original cloud");
    // viewer.setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 3, "original cloud");
